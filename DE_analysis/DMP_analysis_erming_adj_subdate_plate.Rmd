...
Rscript -e "rmarkdown::render('DMP_analysis_erming_adj_subdate_plate.Rmd')"
...
mVal_age_sex_adj <- readRDS("/sc/orga/projects/zhangb03a/lei_guo/BM36_methylation_analysis/processed_data/covariate_adjusted_Beta_M_Erming/batch_subDate/exprset_M_Values_QCed_normlized_batch_plate_pmi_race_age_sex_adjusted.rds")

# read non-sex-adjusted expressionset
mVal_age_adj <- readRDS("/sc/orga/projects/zhangb03a/lei_guo/BM36_methylation_analysis/processed_data/covariate_adjusted_Beta_M_Erming/batch_subDate/exprset_M_Values_QCed_normlized_batch_plate_pmi_race_age_adjusted.rds")
```
