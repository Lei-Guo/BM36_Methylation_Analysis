...
Render the notebook with commandline Rscript -e "rmarkdown::render('make_expressionset_erming_adj.Rmd')"
...
invisible(MVal_plate_pmi_race_adj <- fread("/sc/orga/projects/zhangb03a/lei_guo/BM36_methylation_analysis/processed_data/covariate_adjusted_Beta_M_Erming/batch_subDate/M_Values_QCed_normlized_batch_plate_pmi_race_adjusted.tsv", data.table = F))
...
invisible(MVal_plate_pmi_race_age_adj <- fread("/sc/orga/projects/zhangb03a/lei_guo/BM36_methylation_analysis/processed_data/covariate_adjusted_Beta_M_Erming/batch_subDate/M_Values_QCed_normlized_batch_plate_pmi_race_age_adjusted.tsv", data.table = F))
...
invisible(MVal_plate_pmi_race_sex_adj <- fread("/sc/orga/projects/zhangb03a/lei_guo/BM36_methylation_analysis/processed_data/covariate_adjusted_Beta_M_Erming/batch_subDate/M_Values_QCed_normlized_batch_plate_pmi_race_sex_adjusted.tsv", data.table = F))
...
invisible(MVal_plate_pmi_race_age_sex_adj <- fread("/sc/orga/projects/zhangb03a/lei_guo/BM36_methylation_analysis/processed_data/covariate_adjusted_Beta_M_Erming/batch_subDate/M_Values_QCed_normlized_batch_plate_pmi_race_age_sex_adjusted.tsv", data.table = F))
...
saveRDS(exprset_MVal_plate_pmi_race_adj, file = "/sc/orga/projects/zhangb03a/lei_guo/BM36_methylation_analysis/processed_data/covariate_adjusted_Beta_M_Erming/batch_subDate/exprset_M_Values_QCed_normlized_batch_plate_pmi_race_adjusted.rds")

saveRDS(exprset_MVal_plate_pmi_race_age_adj, file = "/sc/orga/projects/zhangb03a/lei_guo/BM36_methylation_analysis/processed_data/covariate_adjusted_Beta_M_Erming/batch_subDate/exprset_M_Values_QCed_normlized_batch_plate_pmi_race_age_adjusted.rds")

saveRDS(exprset_MVal_plate_pmi_race_age_sex_adj, file = "/sc/orga/projects/zhangb03a/lei_guo/BM36_methylation_analysis/processed_data/covariate_adjusted_Beta_M_Erming/batch_subDate/exprset_M_Values_QCed_normlized_batch_plate_pmi_race_age_sex_adjusted.rds")

saveRDS(exprset_MVal_plate_pmi_race_sex_adj, file = "/sc/orga/projects/zhangb03a/lei_guo/BM36_methylation_analysis/processed_data/covariate_adjusted_Beta_M_Erming/batch_subDate/exprset_M_Values_QCed_normlized_batch_plate_pmi_race_sex_adjusted.rds")
```
