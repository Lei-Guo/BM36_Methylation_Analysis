...
Addding AOD, SEX_inferred, PMI, RACE_inferred, Sentrix_ID, columns to betaVal_t and mVal_t
```{r addding AOD, SEX_inferred, PMI and RACE_inferred columns to betaVal_t and mVal_t}
# for betaVal
...
betaVal_t$Sentrix_ID <- as.factor(meta_rnaseq$Sentrix_ID[match(rownames(betaVal_t), meta_rnaseq$SampleID)])
...
mVal_t$Sentrix_ID <- as.factor(meta_rnaseq$Sentrix_ID[match(rownames(mVal_t), meta_rnaseq$SampleID)])
...
Adjusting for AOD, SEX_inferred, PMI, RACE_inferred, Sentrix_ID
```{r adjusting for AOD, SEX_inferred, PMI, RACE_inferred, Sentrix_ID}
# for betaVal
# regress out the covariates
betaVal_t_resid_age_sex <- parApply(cl, betaVal_t[, betaVal_t_numeric_cols], 2, function(x) rlm(x ~ betaVal_t[,"AOD"] + betaVal_t[,"SEX_inferred"] + betaVal_t[,"PMI"] + betaVal_t[,"RACE_inferred"] + betaVal_t[,"Sentrix_ID"])$resid)
...
# for mVal
# regress out the covariates
mVal_t_resid_age_sex <- parApply(cl, mVal_t[, mVal_t_numeric_cols], 2, function(x) rlm(x ~ mVal_t[,"AOD"] + mVal_t[,"SEX_inferred"] + mVal_t[,"PMI"] + mVal_t[,"RACE_inferred"] + mVal_t[,"Sentrix_ID"])$resid)
...
Adjusting for AOD, PMI, RACE_inferred, Sentrix_ID
```{r adjusting for AOD, PMI, RACE_inferred, Sentrix_ID}
# for betaVal
# regress out the covariates
betaVal_t_resid_age <- parApply(cl, betaVal_t[, betaVal_t_numeric_cols], 2, function(x) rlm(x ~ betaVal_t[,"AOD"] + betaVal_t[,"PMI"] + betaVal_t[,"RACE_inferred"] + betaVal_t[,"Sentrix_ID"])$resid)
...
# for mVal
# regress out the covariates
mVal_t_resid_age <- parApply(cl, mVal_t[, mVal_t_numeric_cols], 2, function(x) rlm(x ~ mVal_t[,"AOD"] + mVal_t[,"PMI"] + mVal_t[,"RACE_inferred"] + mVal_t[,"Sentrix_ID"])$resid)
...
Adjusting for SEX_inferred, PMI, RACE_inferred, Sentrix_ID
```{r adjusting for SEX_inferred, PMI, RACE_inferred, Sentrix_ID}
# for betaVal
# regress out the covariates
betaVal_t_resid_sex <- parApply(cl, betaVal_t[, betaVal_t_numeric_cols], 2, function(x) rlm(x ~ betaVal_t[,"SEX_inferred"] + betaVal_t[,"PMI"] + betaVal_t[,"RACE_inferred"] + betaVal_t[,"Sentrix_ID"])$resid)
...
# for mVal
# regress out the covariates
mVal_t_resid_sex <- parApply(cl, mVal_t[, mVal_t_numeric_cols], 2, function(x) rlm(x ~ mVal_t[,"SEX_inferred"] + mVal_t[,"PMI"] + mVal_t[,"RACE_inferred"] + mVal_t[,"Sentrix_ID"])$resid)
...
Adjusting for PMI, RACE_inferred, Sentrix_ID
```{r adjusting for PMI, RACE_inferred, Sentrix_ID}
# for betaVal
# regress out the covariates
betaVal_t_resid <- parApply(cl, betaVal_t[, betaVal_t_numeric_cols], 2, function(x) rlm(x ~ betaVal_t[,"PMI"] + betaVal_t[,"RACE_inferred"] + betaVal_t[,"Sentrix_ID"])$resid)
...
# for mVal
# regress out the covariates
mVal_t_resid <- parApply(cl, mVal_t[, mVal_t_numeric_cols], 2, function(x) rlm(x ~ mVal_t[,"PMI"] + mVal_t[,"RACE_inferred"] + mVal_t[,"Sentrix_ID"])$resid)
...
fwrite(mVal_age_sex_adjusted, "/sc/orga/projects/zhangb03a/lei_guo/BM36_methylation_analysis/processed_data/qc_normlized_covariates_adjusted_Beta_M/MVals/processed_data/M_Values_qced_normlized_batch_pmi_race_age_sex_adjusted.tsv", row.names = T, sep = "\t")

# writing the age-adjusted mVals
fwrite(mVal_age_adjusted, "/sc/orga/projects/zhangb03a/lei_guo/BM36_methylation_analysis/processed_data/qc_normlized_covariates_adjusted_Beta_M/MVals/M_Values_qced_normlized_batch_pmi_race_age_adjusted.tsv", row.names = T, sep = "\t")

# writing the sex-adjusted mVals
fwrite(mVal_sex_adjusted, "/sc/orga/projects/zhangb03a/lei_guo/BM36_methylation_analysis/processed_data/qc_normlized_covariates_adjusted_Beta_M/MVals/M_Values_qced_normlized_batch_pmi_race_sex_adjusted.tsv", row.names = T, sep = "\t")

# writing the adjusted mVals
fwrite(mVal_adjusted, "/sc/orga/projects/zhangb03a/lei_guo/BM36_methylation_analysis/processed_data/qc_normlized_covariates_adjusted_Beta_M/MVals/M_Values_qced_normlized_batch_pmi_race_adjusted.tsv", row.names = T, sep = "\t")
```

Wrting the adjusted betaVals
```{r writing the adjusted betaVals}
# writing the sex-age-adjusted betaVals
fwrite(betaVal_age_sex_adjusted, "/sc/orga/projects/zhangb03a/lei_guo/BM36_methylation_analysis/processed_data/qc_normlized_covariates_adjusted_Beta_M/BetaVals/Beta_Values_qced_normlized_batch_pmi_race_age_sex_adjusted.tsv", row.names = T, sep = "\t")

# writing the age-adjusted betaVals
fwrite(betaVal_age_adjusted, "/sc/orga/projects/zhangb03a/lei_guo/BM36_methylation_analysis/processed_data/qc_normlized_covariates_adjusted_Beta_M/BetaVals/Beta_Values_qced_normlized_batch_pmi_race_age_adjusted.tsv", row.names = T, sep = "\t")

# writing the sex-adjusted betaVals
fwrite(betaVal_sex_adjusted, "/sc/orga/projects/zhangb03a/lei_guo/BM36_methylation_analysis/processed_data/qc_normlized_covariates_adjusted_Beta_M/BetaVals/Beta_Values_qced_normlized_batch_pmi_race_sex_adjusted.tsv", row.names = T, sep = "\t")

# writing the adjusted betaVals
fwrite(betaVal_adjusted, "/sc/orga/projects/zhangb03a/lei_guo/BM36_methylation_analysis/processed_data/qc_normlized_covariates_adjusted_Beta_M/BetaVals/Beta_Values_qced_normlized_batch_pmi_race_adjusted.tsv", row.names = T, sep = "\t")
```
